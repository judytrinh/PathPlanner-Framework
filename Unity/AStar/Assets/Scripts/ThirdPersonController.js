...
public var perspCamera : Camera;
public var topCamera : Camera;
public var marioCamera : Camera;
...
function UpdateSmoothedMovementDirection ()
{
	...
	if (perspCamera.camera.enabled == true)
		cameraTransform = perspCamera.camera.transform;
	else if (marioCamera.camera.enabled == true)
		cameraTransform = marioCamera.camera.transform;
	else
		cameraTransform = topCamera.camera.transform;
